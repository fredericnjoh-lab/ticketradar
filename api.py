...
async def alert_scan(seuil: int = 30, sheet_url: str = ""):
    ...
    try:
        ...
        async with httpx.AsyncClient(timeout=15, follow_redirects=True, headers=sheet_headers) as client:
...
async def alert_notify(payload: dict):
    """
    Reçoit les events depuis l'app et envoie des alertes Telegram.
    Body: {"events": [...], "seuil": 30}
    """
